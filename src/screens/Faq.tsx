...
const content: {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p>
          Applicable projects should not be ENS-specific but may include ENS functionality. An example is ethers.js, a
          developer library that has utility throughout Web3, not only for those building with ENS.
        </p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p>
          Applicable projects are meaningfully building, creating content, or improving the ENS ecosystem. An example is
          ENSfairy.xyz, an ENS name-gifting tool that adds explicit functionality to the ENS ecosystem.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    answer: (
      <p>
        There is no required template. We encourage creativity. Consider the use of markdown to craft a well-organized
        proposal.{' '}
